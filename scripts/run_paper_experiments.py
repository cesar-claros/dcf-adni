...
Usage::
    ...
    python scripts/run_paper_experiments.py --block labeling
    python scripts/run_paper_experiments.py --block training --strategy L4
    python scripts/run_paper_experiments.py --block transfer --strategy L4
    python scripts/run_paper_experiments.py --block bmca_comparison --strategy L4
    python scripts/run_paper_experiments.py --block stacking --strategy L4
    python scripts/run_paper_experiments.py --block contrast --strategy L4
    python scripts/run_paper_experiments.py --block summary

    # Run everything (labeling uses seed 0; training/transfer use seeds 0-4)
    python scripts/run_paper_experiments.py --block all --strategy L4
"""
