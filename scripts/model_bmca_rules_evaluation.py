...
Usage::
    ...
    python scripts/model_bmca_rules_evaluation.py
    python scripts/model_bmca_rules_evaluation.py --n_iter 100 --seed 42
"""
...
from dcf_adni.modeling.utils_model import (
