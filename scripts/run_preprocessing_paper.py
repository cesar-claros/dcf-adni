...
Usage::
    ...
    python scripts/run_preprocessing_paper.py
    python scripts/run_preprocessing_paper.py --strategies L1,L4
    python scripts/run_preprocessing_paper.py --input_csv data/custom.csv --output_dir data
"""
