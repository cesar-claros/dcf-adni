...
Usage::
    ...
    python scripts/model_bmca_feature_engineering_evaluation.py
    python scripts/model_bmca_feature_engineering_evaluation.py --n_iter 100 --seed 42
"""
