...
Usage::
    ...
    python scripts/model_within_pair_contrast_evaluation.py
    python scripts/model_within_pair_contrast_evaluation.py --n_iter 100 --seed 42
"""
...
def _train_and_evaluate(
    ...
    logger.info(
        f"Training {model_name}: {len(feats)} features, {len(X_train)} train rows."
    )
