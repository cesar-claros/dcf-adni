...
Usage::
    ...
    python scripts/model_aug_distilled_mrf_evaluation.py
    python scripts/model_aug_distilled_mrf_evaluation.py --n_iter 100 --seed 42
"""
...
def assign_mrf_aug_scores(
    ...
    """
    mrf_feats = feature_cols(mrf_train)
